...
const TARJETAS = [
    { key: 'masculino', label: '💪 Masculino', color: 'border-blue-300 bg-blue-50', genero: 'masculino', soloEstudiante: false },
    { key: 'femenino', label: '🌸 Femenino', color: 'border-pink-300 bg-pink-50', genero: 'femenino', soloEstudiante: false },
    { key: 'estudiante_m', label: '🎓 Estudiante Masculino', color: 'border-blue-300 bg-blue-50', genero: 'masculino', soloEstudiante: true },
                        ...
                        return (
                            <div key={tarjeta.key} className={`border-2 rounded-lg ${tarjeta.color} overflow-hidden`}>
                                ...
                                {planesTarjeta.length === 0 ? (
                                    <div className="px-5 py-8 text-center text-gray-400 text-sm">No hay planes en esta categoría</div>
                                ) : (
                                            ...
                                            <div key={p.id} className="bg-white rounded-lg border border-gray-200 p-4 flex items-center justify-between hover:shadow-sm transition-shadow">
                                                <div className="flex-1">
                                                    ...
                                                    {tarjeta.soloEstudiante && (
                                                        <div className="mt-1">
                                                            <span className="inline-block px-1.5 py-0.5 bg-blue-100 text-blue-800 rounded text-xs font-medium">🎓 Plan Estudiante</span>
                                                        </div>
                                                    )}
                                                </div>
                                ...
                                {formData.es_estudiante && (
                                    <>
                                        <div className="flex items-center gap-2 mt-2">
                                            <span className="inline-block px-2 py-0.5 bg-blue-100 text-blue-800 rounded text-xs font-medium">🎓 Creando/Editando plan estudiante</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <label htmlFor="req_cert" className="text-sm text-gray-700">🎓 Requiere certificado de estudiante</label>
                                        </div>
                                    </>
                                )}
                                <div className="flex items-center gap-2">
