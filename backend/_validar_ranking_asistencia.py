...
- SEED aislado con prefijo inconfundible (subdomain 'test-ranking-*') sobre la
  base TEST (branch billowing-violet-acdqud44), verificado vía /debug/db-url antes de
...
def main():
    # Seguridad: verificar que el servidor apunte a TEST (branch billowing-violet-acdqud44).
    try:
