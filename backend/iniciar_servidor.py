"""
Start uvicorn with ENVIRONMENT=test (billowing-violet-acdqud44 BD).
...
is_test = "billowing-violet-acdqud44" in db_url
...
if is_test:
    print("  CONECTADO A BD de TEST (billowing-violet-acdqud44)")
else:
