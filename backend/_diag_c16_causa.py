...
test_c16_sin_clases_duplicadas usando la BD TEST (billowing-violet-acdqud44).
...
print(f"BD TEST: billowing-violet-acdqud44 = {'billowing-violet-acdqud44' in URL_TEST}")
print("=" * 70)
